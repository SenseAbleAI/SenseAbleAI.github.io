          ...
          <div className="w-full lg:w-1/2 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 p-6 md:p-8 lg:p-10 xl:p-12 flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center py-4">
              <div className="max-w-lg w-full">
                ...
                {/* Repository Info Box */}
                <div className="bg-purple-100 border border-purple-200 rounded-lg p-3 md:p-4 max-w-md mt-3 md:mt-4">
                  <div className="flex gap-2 md:gap-3">
                    <svg 
                      className="text-purple-600 w-5 h-5 md:w-6 md:h-6 flex-shrink-0" 
                      fill="currentColor" 
                      viewBox="0 0 24 24"
                    >
                    ...
                    <div className="flex-1">
                      <p className="text-xs md:text-sm text-gray-700">
                        We additionally provide a public repository containing inspectable backend code and system resources (excluding restricted model endpoints){' '}
                        <a 
                          href="https://github.com/SenseAbleAI/codes" 
                          target="_blank" 
